...
public class api {
    ...
    public static final int MSAT_FINAL_TOLERANCE = 6;
    ...
    // msat_opt_result
    public static final int MSAT_OPT_UNKNOWN = -1;
    public static final int MSAT_OPT_UNSAT = 0;
    public static final int MSAT_OPT_SAT_PARTIAL = 1;
    public static final int MSAT_OPT_SAT_APPROX = 2;
    public static final int MSAT_OPT_SAT_OPTIMAL = 3;
    ...
    // returns an objective, or null in case of errors
    public static Long msat_objective_iterator_next(long i) {
       long[] o = new long[1];
       int s = msat_objective_iterator_next(i, o);
       if (s == -1) return null;
       return new Long(o[0]);
    }    
    ...
    public static native long msat_make_minmax_signed(long e, int len, long[] terms, long lower, long upper);
    public static native long msat_make_maxmin(long e, int len, long[] terms, long lower, long upper);
    public static native long msat_make_maxmin_signed(long e, int len, long[] terms, long lower, long upper);
    public static native int msat_assert_objective(long e, long o);
    public static native void msat_destroy_objective(long e, long o);
    public static native int msat_assert_soft_formula(long e, long term, long weight, String id);
    ...
    public static native int msat_objective_get_type(long e, long o);
    public static native int msat_load_objective_model(long e, long o);
    ...
    public static native int msat_objective_value_get_epsilon(long e, long o, int i);
    public static native long msat_objective_value_term(long e, long o, int i, long inf, long eps);
    public static native long msat_objective_get_model(long e, long o);
